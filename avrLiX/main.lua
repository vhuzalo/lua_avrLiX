...
local function configure(widget)
    ...
    form.addSourceField(line, nil, function() return widget.voltageSource end,
        function(value) widget.voltageSource = value end)
    line    = form.addLine("Callout Switch / Repeat")
    local r = form.getFieldSlots(line, { 0, 0 })
    form.addSwitchField(line, r[1], function() return widget.calloutSwitch end,
        function(value) widget.calloutSwitch = value end)
    local field = form.addNumberField(line, r[2], 0, 60, function() return widget.repeatSeconds end,
        function(value) widget.repeatSeconds = value end)
    field:suffix(" s")
    field:default(30)
    line = form.addLine("Number Cell's")
    local field = form.addNumberField(line, nil, 1, 20, function() return widget.numberCells end,
        function(value) widget.numberCells = value end)
    field:suffix(" Cells")
    field:default(1)
    line        = form.addLine("min/max Voltage")
    local r     = form.getFieldSlots(line, { 0, 0 })
    local field = form.addNumberField(line, r[1], 1, 50, function() return widget.minCellVoltage * 10 end,
        function(value) widget.minCellVoltage = value / 10 end)
    field:suffix(" V")
    field:decimals(1)
    field:default(30)
    local field = form.addNumberField(line, r[2], 1, 50, function() return widget.maxCellVoltage * 10 end,
        function(value) widget.maxCellVoltage = value / 10 end)
    field:suffix(" V")
    field:decimals(1)
    field:default(30)
    line        = form.addLine("low Alarm V/delay")
    local r     = form.getFieldSlots(line, { 0, 0 })
    local field = form.addNumberField(line, r[1], 1, 50, function() return widget.lowAlarmVoltage * 10 end,
        function(value) widget.lowAlarmVoltage = value / 10 end)
    field:suffix(" V")
    field:decimals(1)
    field:default(30)
    local field = form.addNumberField(line, r[2], 0, 20, function() return widget.waitSecondsLowAlarm end,
        function(value) widget.waitSecondsLowAlarm = value end)
    field:suffix(" s")
    field:default(1)
    line        = form.addLine("critical Alarm V/delay")
    local r     = form.getFieldSlots(line, { 0, 0 })
    local field = form.addNumberField(line, r[1], 1, 50, function() return widget.criticalAlarmVoltage * 10 end,
        function(value) widget.criticalAlarmVoltage = value / 10 end)
    field:suffix(" V")
    field:decimals(1)
    field:default(30)
    local field = form.addNumberField(line, r[2], 0, 20, function() return widget.waitSecondsCriticalAlarm end,
        function(value) widget.waitSecondsCriticalAlarm = value end)
    field:suffix(" s")
    field:default(1)
end --function
...
local function init()
    system.registerWidget({ key = "avrvolt", name = name, create = create, paint = paint, wakeup = wakeup, configure =
    configure, read = read, write = write })
end
